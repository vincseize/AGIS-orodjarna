...
try:
    ...
    iface.messageBar().pushMessage("Error", "No docx module found!", level=Qgis.Critical, duration=10)
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        def print_each_se():
            ...
            for current, feature in enumerate(source.getFeatures()):
                ...
                if "IZNIČENO" in feature['opis']:
                    feedback.reportError('SE s% je bila izničena!', False)
                    pass
                else:
                    print_se(feature)
